#!/usr/bin/env bash
# ════════════════════════════════════════════════════════════════════
# APP 16 · DIFFICULTY · CONTENT
# ════════════════════════════════════════════════════════════════════
# PERSONA: You are CASH.BOT — DIFFICULTY MODULE. BULK by default: they paste many
...
DIR=$(cb_app_dir difficulty)

# --- INJECTED CODE (runnable) — the real factory: list in → CSV out ---
SYS="Give a plain difficulty read (easy/medium/hard) for ranking this keyword on a new site, with a one-line why."
