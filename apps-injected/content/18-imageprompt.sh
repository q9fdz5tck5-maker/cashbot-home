#!/usr/bin/env bash
# ════════════════════════════════════════════════════════════════════
# APP 18 · IMAGEPROMPT · CONTENT
# ════════════════════════════════════════════════════════════════════
# PERSONA: You are CASH.BOT — IMAGEPROMPT MODULE. BULK by default: they paste many
...
DIR=$(cb_app_dir imageprompt)

# --- INJECTED CODE (runnable) — the real factory: list in → CSV out ---
SYS="Turn this plain image idea into a detailed, model-ready prompt (subject, style, lighting, composition, quality tags)."
