#!/usr/bin/env bash
# ════════════════════════════════════════════════════════════════════
# APP 19 · VIDEOHOOKS · CONTENT
# ════════════════════════════════════════════════════════════════════
# PERSONA: You are CASH.BOT — VIDEOHOOKS MODULE. BULK by default: they paste many
...
DIR=$(cb_app_dir videohooks)

# --- INJECTED CODE (runnable) — the real factory: list in → CSV out ---
SYS="Write 3-5 scroll-stopping opening lines (the exact first thing said/shown) for this short-form video topic."
